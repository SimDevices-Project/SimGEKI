...
extern int riscv_stack_protector_guard_reg;
#else
  int x_riscv_stack_protector_guard_reg;
#define riscv_stack_protector_guard_reg global_options.x_riscv_stack_protector_guard_reg
#endif
#ifdef GENERATOR_FILE
extern int riscv_vector_elen_flags;
#else
  int x_riscv_vector_elen_flags;
#define riscv_vector_elen_flags global_options.x_riscv_vector_elen_flags
#endif
#ifdef GENERATOR_FILE
extern int riscv_zb_subext;
#else
  int x_riscv_zb_subext;
#define riscv_zb_subext global_options.x_riscv_zb_subext
#endif
#ifdef GENERATOR_FILE
...
#define riscv_zvl_flags global_options.x_riscv_zvl_flags
#endif
#ifdef GENERATOR_FILE
extern long riscv_stack_protector_guard_offset;
#else
  long x_riscv_stack_protector_guard_offset;
#define riscv_stack_protector_guard_offset global_options.x_riscv_stack_protector_guard_offset
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int param_highcode_gen_section_name;
#else
  int x_param_highcode_gen_section_name;
#define param_highcode_gen_section_name global_options.x_param_highcode_gen_section_name
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern const char *riscv_stack_protector_guard_offset_str;
#else
  const char *x_riscv_stack_protector_guard_offset_str;
#define riscv_stack_protector_guard_offset_str global_options.x_riscv_stack_protector_guard_offset_str
#endif
#ifdef GENERATOR_FILE
extern const char *riscv_stack_protector_guard_reg_str;
#else
  const char *x_riscv_stack_protector_guard_reg_str;
#define riscv_stack_protector_guard_reg_str global_options.x_riscv_stack_protector_guard_reg_str
#endif
#ifdef GENERATOR_FILE
extern enum stack_protector_guard riscv_stack_protector_guard;
#else
  enum stack_protector_guard x_riscv_stack_protector_guard;
#define riscv_stack_protector_guard global_options.x_riscv_stack_protector_guard
#endif
#ifdef GENERATOR_FILE
...
#define MASK_BIG_ENDIAN (1U << 0)
#define MASK_DIV (1U << 1)
#define MASK_EXPLICIT_RELOCS (1U << 2)
#define MASK_FDIV (1U << 3)
#define MASK_SAVE_RESTORE (1U << 4)
#define MASK_STRICT_ALIGN (1U << 5)
#define MASK_64BIT (1U << 6)
#define MASK_ATOMIC (1U << 7)
...
#define TARGET_EXPLICIT_BIG_ENDIAN_P(opts) ((opts->x_target_flags_explicit & MASK_BIG_ENDIAN) != 0)
#define SET_TARGET_BIG_ENDIAN(opts) opts->x_target_flags |= MASK_BIG_ENDIAN
/* DIV mask */
#define TARGET_DIV ((target_flags & MASK_DIV) != 0)
#define TARGET_DIV_P(target_flags) (((target_flags) & MASK_DIV) != 0)
#define TARGET_EXPLICIT_DIV_P(opts) ((opts->x_target_flags_explicit & MASK_DIV) != 0)
#define SET_TARGET_DIV(opts) opts->x_target_flags |= MASK_DIV
/* EXPLICIT_RELOCS mask */
...
#define TARGET_EXPLICIT_EXPLICIT_RELOCS_P(opts) ((opts->x_target_flags_explicit & MASK_EXPLICIT_RELOCS) != 0)
#define SET_TARGET_EXPLICIT_RELOCS(opts) opts->x_target_flags |= MASK_EXPLICIT_RELOCS
/* FDIV mask */
#define TARGET_FDIV ((target_flags & MASK_FDIV) != 0)
#define TARGET_FDIV_P(target_flags) (((target_flags) & MASK_FDIV) != 0)
#define TARGET_EXPLICIT_FDIV_P(opts) ((opts->x_target_flags_explicit & MASK_FDIV) != 0)
#define SET_TARGET_FDIV(opts) opts->x_target_flags |= MASK_FDIV
/* SAVE_RESTORE mask */
...
#define TARGET_EXPLICIT_SAVE_RESTORE_P(opts) ((opts->x_target_flags_explicit & MASK_SAVE_RESTORE) != 0)
#define SET_TARGET_SAVE_RESTORE(opts) opts->x_target_flags |= MASK_SAVE_RESTORE
/* STRICT_ALIGN mask */
...
enum opt_code
{
  ...
  OPT__param_highcode_gen_section_name_ = 109,/* --param=highcode-gen-section-name= */
  ...
  OPT__param_ipa_cp_profile_count_base_ = 128,/* --param=ipa-cp-profile-count-base= */
  OPT__param_ipa_cp_recursion_penalty_ = 129,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_recursive_freq_factor_ = 130,/* --param=ipa-cp-recursive-freq-factor= */
  ...
  OPT__param_relation_block_limit_ = 283,    /* --param=relation-block-limit= */
  ...
  OPT__param_vect_induction_float_ = 334,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 335,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_peeling_for_alignment_ = 336,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 337,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 338,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 339,/* --param=vect-partial-vector-usage= */
  OPT__param_vrp1_mode_ = 340,               /* --param=vrp1-mode= */
  OPT__param_vrp2_mode_ = 341,               /* --param=vrp2-mode= */
  ...
  OPT_list = 1764,                           /* -list */
  OPT_mabi_ = 1765,                          /* -mabi= */
  OPT_malign_data_ = 1766,                   /* -malign-data= */
  OPT_march_ = 1767,                         /* -march= */
  OPT_mbig_endian = 1768,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1769,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1770,                       /* -mcmodel= */
  OPT_mcpu_ = 1771,                          /* -mcpu= */
  OPT_mdiv = 1772,                           /* -mdiv */
  OPT_mexplicit_relocs = 1773,               /* -mexplicit-relocs */
  OPT_mfdiv = 1774,                          /* -mfdiv */
  OPT_misa_spec_ = 1775,                     /* -misa-spec= */
  OPT_mlittle_endian = 1776,                 /* -mlittle-endian */
  OPT_mplt = 1777,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1778,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1779,                         /* -mrelax */
  OPT_mriscv_attribute = 1780,               /* -mriscv-attribute */
  OPT_msave_restore = 1781,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1782,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1783,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 1784, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1785,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1786,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1787,                  /* -mstrict-align */
  OPT_mtune_ = 1788,                         /* -mtune= */
  OPT_n = 1789,                              /* -n */
  OPT_name_sort = 1790,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1791,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1792,              /* -no-integrated-cpp */
  OPT_no_pie = 1793,                         /* -no-pie */
  OPT_nocpp = 1794,                          /* -nocpp */
  OPT_nodefaultlibs = 1795,                  /* -nodefaultlibs */
  OPT_nolibc = 1796,                         /* -nolibc */
  OPT_nophoboslib = 1797,                    /* -nophoboslib */
  OPT_nostartfiles = 1798,                   /* -nostartfiles */
  OPT_nostdinc = 1799,                       /* -nostdinc */
  OPT_nostdinc__ = 1800,                     /* -nostdinc++ */
  OPT_nostdlib = 1801,                       /* -nostdlib */
  OPT_o = 1802,                              /* -o */
  OPT_objects = 1803,                        /* -objects */
  OPT_p = 1804,                              /* -p */
  OPT_pass_exit_codes = 1805,                /* -pass-exit-codes */
  /* OPT_pedantic = 1806, */                 /* -pedantic */
  OPT_pedantic_errors = 1807,                /* -pedantic-errors */
  OPT_pg = 1808,                             /* -pg */
  OPT_pie = 1809,                            /* -pie */
  OPT_pipe = 1810,                           /* -pipe */
  ...
  OPT_quiet = 1823,                          /* -quiet */
  OPT_r = 1824,                              /* -r */
  OPT_remap = 1825,                          /* -remap */
  OPT_reverse_sort = 1826,                   /* -reverse-sort */
  OPT_s = 1827,                              /* -s */
  OPT_save_temps = 1828,                     /* -save-temps */
  OPT_save_temps_ = 1829,                    /* -save-temps= */
  OPT_shared = 1830,                         /* -shared */
  OPT_shared_libgcc = 1831,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1832,               /* -shared-libphobos */
  OPT_size_sort = 1833,                      /* -size-sort */
  /* OPT_specs = 1834, */                    /* -specs */
  OPT_specs_ = 1835,                         /* -specs= */
  OPT_static = 1836,                         /* -static */
  OPT_static_libasan = 1837,                 /* -static-libasan */
  OPT_static_libgcc = 1838,                  /* -static-libgcc */
  OPT_static_libgfortran = 1839,             /* -static-libgfortran */
  OPT_static_libgo = 1840,                   /* -static-libgo */
  OPT_static_libhwasan = 1841,               /* -static-libhwasan */
  OPT_static_liblsan = 1842,                 /* -static-liblsan */
  OPT_static_libmpx = 1843,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1844,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1845,               /* -static-libphobos */
  OPT_static_libstdc__ = 1846,               /* -static-libstdc++ */
  OPT_static_libtsan = 1847,                 /* -static-libtsan */
  OPT_static_libubsan = 1848,                /* -static-libubsan */
  OPT_static_pie = 1849,                     /* -static-pie */
  /* OPT_std_c__03 = 1850, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1851, */                /* -std=c++0x */
  OPT_std_c__11 = 1852,                      /* -std=c++11 */
  OPT_std_c__14 = 1853,                      /* -std=c++14 */
  OPT_std_c__17 = 1854,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1855, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1856, */                /* -std=c++1z */
  OPT_std_c__20 = 1857,                      /* -std=c++20 */
  OPT_std_c__23 = 1858,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1859, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1860, */                /* -std=c++2b */
  ...
  OPT_std_gnu__23 = 1885,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1886, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1887, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1888,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1889,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1890,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1891, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1892, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1893,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1894, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1895,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1896,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1897, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1898, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1899,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1900, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1901, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1902, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1903, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1904, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1905,                     /* -std=legacy */
  OPT_stdlib_ = 1906,                        /* -stdlib= */
  OPT_symbol_ = 1907,                        /* -symbol= */
  OPT_symbolic = 1908,                       /* -symbolic */
  OPT_t = 1909,                              /* -t */
  OPT_time = 1910,                           /* -time */
  OPT_time_ = 1911,                          /* -time= */
  OPT_traditional = 1912,                    /* -traditional */
  OPT_traditional_cpp = 1913,                /* -traditional-cpp */
  OPT_tree_stats = 1914,                     /* -tree-stats */
  OPT_trigraphs = 1915,                      /* -trigraphs */
  OPT_type_stats = 1916,                     /* -type-stats */
  OPT_u = 1917,                              /* -u */
  OPT_undef = 1918,                          /* -undef */
  OPT_v = 1919,                              /* -v */
  OPT_version = 1920,                        /* -version */
  OPT_w = 1921,                              /* -w */
  OPT_wrapper = 1922,                        /* -wrapper */
  OPT_x = 1923,                              /* -x */
  OPT_z = 1924,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
