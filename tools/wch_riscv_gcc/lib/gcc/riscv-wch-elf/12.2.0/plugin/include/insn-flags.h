...
#define HAVE_mulsi3 ((TARGET_MUL || TARGET_ZMMUL))
#define HAVE_muldi3 ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_smuldi3_highpart ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_umuldi3_highpart ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_usmuldi3_highpart ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_smulsi3_highpart ((TARGET_MUL || TARGET_ZMMUL) && !TARGET_64BIT)
#define HAVE_umulsi3_highpart ((TARGET_MUL || TARGET_ZMMUL) && !TARGET_64BIT)
#define HAVE_usmulsi3_highpart ((TARGET_MUL || TARGET_ZMMUL) && !TARGET_64BIT)
...
#define HAVE_mulditi3 ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_umulditi3 ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_usmulditi3 ((TARGET_MUL || TARGET_ZMMUL) && TARGET_64BIT)
#define HAVE_mulsidi3 ((TARGET_MUL || TARGET_ZMMUL) && !TARGET_64BIT)
#define HAVE_umulsidi3 ((TARGET_MUL || TARGET_ZMMUL) && !TARGET_64BIT)
#define HAVE_usmulsidi3 ((TARGET_MUL || TARGET_ZMMUL) && !TARGET_64BIT)
